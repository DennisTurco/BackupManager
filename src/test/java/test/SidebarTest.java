 ...
 * @author ian
 */
public class SidebarTest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        settings.setIcon(new javax.swing.ImageIcon(getClass().getResource("/test/settings (Custom).png"))); // NOI18N
        ...
        home.setIcon(new javax.swing.ImageIcon(getClass().getResource("/test/home (Custom).png"))); // NOI18N
        home.setText("Home");
        ...
        men.setIcon(new javax.swing.ImageIcon(getClass().getResource("/test/menu_15.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(sidebar, javax.swing.GroupLayout.DEFAULT_SIZE, 427, Short.MAX_VALUE)
            .addComponent(mainPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SidebarTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SidebarTest().setVisible(true);
            }
        });
    }
