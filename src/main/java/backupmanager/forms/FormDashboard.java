...
import backupmanager.component.ToolBarSelection;
import backupmanager.component.chart.BarChart;
import backupmanager.component.chart.CandlestickChart;
import backupmanager.component.chart.PieChart;
import backupmanager.component.chart.SpiderChart;
import backupmanager.component.chart.TimeSeriesChart;
import backupmanager.component.chart.renderer.other.ChartCandlestickRenderer;
import backupmanager.component.chart.themes.ColorThemes;
import backupmanager.component.chart.themes.DefaultChartTheme;
import backupmanager.component.chart.utils.ToolBarCategoryOrientation;
import backupmanager.component.chart.utils.ToolBarTimeSeriesChartRenderer;
import backupmanager.component.dashboard.CardBox;
import backupmanager.sample.SampleData;
...
public class FormDashboard extends Form {
    ...
    private void createCard() {
        ...
        cardBox = new CardBox();
        cardBox.addCardItem(createIcon("icons/dashboard/customer.svg", DefaultChartTheme.getColor(0)), "Total Customer");
        cardBox.addCardItem(createIcon("icons/dashboard/income.svg", DefaultChartTheme.getColor(1)), "Total Income");
        cardBox.addCardItem(createIcon("icons/dashboard/expense.svg", DefaultChartTheme.getColor(2)), "Total Expense");
        cardBox.addCardItem(createIcon("icons/dashboard/profit.svg", DefaultChartTheme.getColor(3)), "Last Profit");
        panel.add(cardBox);
