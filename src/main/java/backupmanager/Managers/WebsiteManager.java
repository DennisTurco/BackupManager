...
public class WebsiteManager {
    ...
    public static void openWebSite(String reportUrl) {
        try {
            ...
            JOptionPane.showMessageDialog(null, Translations.get(TKey.ERROR_MESSAGE_OPENING_WEBSITE), Translations.get(TKey.ERROR_GENERIC_TITLE), JOptionPane.ERROR_MESSAGE);
        }
    }
        ...
        if (Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(Desktop.Action.MAIL)) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, Translations.get(TKey.ERROR_MESSAGE_UNABLE_TO_SEND_EMAIL), Translations.get(TKey.ERROR_GENERIC_TITLE), JOptionPane.ERROR_MESSAGE);
                }
            } else {
                logger.warn("Mail action is unsupported in your system's desktop environment.");
                JOptionPane.showMessageDialog(null, Translations.get(TKey.ERROR_MESSAGE_NOT_SUPPORTED_EMAIL), Translations.get(TKey.ERROR_GENERIC_TITLE), JOptionPane.ERROR_MESSAGE);
            }
        } else {
            logger.warn("Desktop integration is unsupported on this system.");
            JOptionPane.showMessageDialog(null, Translations.get(TKey.ERROR_MESSAGE_NOT_SUPPORTED_EMAIL_GENERIC), Translations.get(TKey.ERROR_GENERIC_TITLE), JOptionPane.ERROR_MESSAGE);
        }
    }
