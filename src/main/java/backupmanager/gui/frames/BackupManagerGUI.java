...
import backupmanager.gui.Table.BackupTableModel;
import backupmanager.gui.Table.CheckboxCellRenderer;
import backupmanager.gui.Table.StripedRowRenderer;
import backupmanager.database.Repositories.BackupConfigurationRepository;
import backupmanager.gui.frames.Controllers.BackupManagerController;
import backupmanager.gui.frames.Controllers.BackupMenuController;
...
public final class BackupManagerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        exportAsPdfBtn = new backupmanager.gui.svg.SVGButton();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        table = new javax.swing.JTable();
        addBackupEntryButton = new backupmanager.gui.svg.SVGButton();
        exportAsCsvBtn = new backupmanager.gui.svg.SVGButton();
        ...
        MenuNew = new backupmanager.gui.svg.SVGMenuItem();
        MenuSave = new backupmanager.gui.svg.SVGMenuItem();
        MenuSaveWithName = new backupmanager.gui.svg.SVGMenuItem();
        jSeparator4 = new javax.swing.JPopupMenu.Separator();
        MenuImport = new backupmanager.gui.svg.SVGMenuItem();
        MenuExport = new backupmanager.gui.svg.SVGMenuItem();
        jSeparator5 = new javax.swing.JPopupMenu.Separator();
        MenuClear = new backupmanager.gui.svg.SVGMenuItem();
        MenuHistory = new backupmanager.gui.svg.SVGMenuItem();
        jMenu2 = new javax.swing.JMenu();
        MenuPreferences = new backupmanager.gui.svg.SVGMenuItem();
        MenuQuit = new backupmanager.gui.svg.SVGMenuItem();
        jMenu3 = new javax.swing.JMenu();
        MenuWebsite = new backupmanager.gui.svg.SVGMenuItem();
        MenuInfoPage = new backupmanager.gui.svg.SVGMenuItem();
        MenuShare = new backupmanager.gui.svg.SVGMenuItem();
        MenuDonate = new backupmanager.gui.svg.SVGMenu();
        MenuPaypalDonate = new backupmanager.gui.svg.SVGMenuItem();
        MenuBuyMeACoffeDonate = new backupmanager.gui.svg.SVGMenuItem();
        jMenu5 = new javax.swing.JMenu();
        MenuBugReport = new backupmanager.gui.svg.SVGMenuItem();
        MenuSupport = new backupmanager.gui.svg.SVGMenuItem();
    ...
    private backupmanager.gui.svg.SVGMenuItem MenuBugReport;
    private backupmanager.gui.svg.SVGMenuItem MenuBuyMeACoffeDonate;
    private backupmanager.gui.svg.SVGMenuItem MenuClear;
    private backupmanager.gui.svg.SVGMenu MenuDonate;
    private backupmanager.gui.svg.SVGMenuItem MenuExport;
    private backupmanager.gui.svg.SVGMenuItem MenuHistory;
    private backupmanager.gui.svg.SVGMenuItem MenuImport;
    private backupmanager.gui.svg.SVGMenuItem MenuInfoPage;
    private backupmanager.gui.svg.SVGMenuItem MenuNew;
    private backupmanager.gui.svg.SVGMenuItem MenuPaypalDonate;
    private backupmanager.gui.svg.SVGMenuItem MenuPreferences;
    private backupmanager.gui.svg.SVGMenuItem MenuQuit;
    private backupmanager.gui.svg.SVGMenuItem MenuSave;
    private backupmanager.gui.svg.SVGMenuItem MenuSaveWithName;
    private backupmanager.gui.svg.SVGMenuItem MenuShare;
    private backupmanager.gui.svg.SVGMenuItem MenuSupport;
    private backupmanager.gui.svg.SVGMenuItem MenuWebsite;
    ...
    private backupmanager.gui.svg.SVGButton addBackupEntryButton;
    ...
    private backupmanager.gui.svg.SVGButton exportAsCsvBtn;
    private backupmanager.gui.svg.SVGButton exportAsPdfBtn;
