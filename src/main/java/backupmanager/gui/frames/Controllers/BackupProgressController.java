...
public class BackupProgressController {
    ...
    public void handleCancelButtonRequest(javax.swing.JDialog dialog) {
        int response = JOptionPane.showConfirmDialog(dialog, Translations.get(TKey.INTERRUPT_BACKUP_PROCESS_MESSAGE), Translations.get(TKey.CONFIRMATION_REQUIRED_TITLE), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
