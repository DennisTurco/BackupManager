...
import backupmanager.gui.component.chart.renderer.bar.ChartBarRenderer;
...
public class BarChart extends DefaultChartPanel {
    ...
    protected JFreeChart createChart() {
        return ChartFactory.createBarChart(null, null, null, new DefaultCategoryDataset());
    }
    ...
    private BarRenderer getDefaultRenderer() {
